...
INSERT INTO sqlpage_files (path, contents, last_modified) VALUES (
  ...
  "image": "https://lib.drh.diabetestechnology.org/service/diabetes-research-hub/assets/diabetic-research-hub-logo.png"
};',
      CURRENT_TIMESTAMP)
...
INSERT INTO sqlpage_files (path, contents, last_modified) VALUES (
      ...
      'SELECT ''shell'' AS component,
       ...
       ''https://lib.drh.diabetestechnology.org/service/diabetes-research-hub/assets/diabetic-research-hub-logo.png'' AS image;',
      CURRENT_TIMESTAMP)
  ON CONFLICT(path) DO UPDATE SET contents = EXCLUDED.contents, last_modified = CURRENT_TIMESTAMP;
INSERT INTO sqlpage_files (path, contents, last_modified) VALUES (
      'index.sql',
