...
export class ConsoleSqlPages extends spn.TypicalSqlPageNotebook {
  ...
  @spn.navigationPrimeTopLevel({
    ...
    description: "Explore RSSD information schema, code notebooks, and SQLPage files",
    siblingOrder: 999,
  })
  "console/index.sql"() {
    return this.SQL`
  ...
  @consoleNav({
    ...
    description: "Explore RSSD tables, columns, views, and other information schema documentation",
    siblingOrder: 1,
  })
  ...
  @consoleNav({
    ...
    description: "Explore RSSD SQLPage Files which govern the content of the web-UI",
    siblingOrder: 3,
  })
  ...
  @consoleNav({
    ...
    description: "See all the navigation entries for the web-UI; TODO: need to improve this to be able to get details for each navigation entry as a table",
    siblingOrder: 3,
  })
  ...
  @consoleNav({
    ...
    description: "Explore RSSD Code Notebooks which contain reusable SQL and other code blocks",
    siblingOrder: 2,
  })
